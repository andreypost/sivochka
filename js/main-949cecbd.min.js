...
"use strict";!function(t,n){function e(t,e){var n=new XMLHttpRequest;n.onload=function(){4==this.readyState&&200==this.status&&e.insertAdjacentHTML("afterbegin",n.responseText)},n.open("GET",t,!0),n.send(null)}if("localhost"!==location.hostname&&"127.0.0.1"!==location.hostname&&""!==location.host){if(!n.createElementNS||!n.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect)return;var o,a="localStorage"in t&&null!==t.localStorage,s=function(){n.body.insertAdjacentHTML("afterbegin",o)};["/wp-content/themes/ukrmeatbest/img/symbol_sprite.html","/wp-content/themes/ukrmeatbest/img/gradient.svg"].forEach(function(t){try{var e=new XMLHttpRequest;e.open("GET",t,!0),e.onload=function(){200<=e.status&&e.status<400&&(o=e.responseText,n.body?s():n.addEventListener("DOMContentLoaded",s),a&&(localStorage.setItem("inlineSVGdata",o),localStorage.setItem("inlineSVGrev",9)))},e.send()}catch(t){}})}else e("/img/symbol_sprite.html",n.querySelector("body")),e("/img/gradient.svg",n.querySelector("body"))}(window,document);