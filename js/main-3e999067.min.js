...
"use strict";!function(e,n){var t,o,i;if("localhost"!==location.hostname&&"127.0.0.1"!==location.hostname&&""!==location.host){if(!n.createElementNS||!n.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect)return;var s,a="localStorage"in e&&null!==e.localStorage,c=function(){n.body.insertAdjacentHTML("afterbegin",s)};["/img/symbol_sprite.html","/img/svg/*"].forEach(function(e){console.log(e);try{var t=new XMLHttpRequest;t.open("GET",e,!0),t.onload=function(){200<=t.status&&t.status<400&&(s=t.responseText,n.body?c():n.addEventListener("DOMContentLoaded",c),a&&(localStorage.setItem("inlineSVGdata",s),localStorage.setItem("inlineSVGrev",9)))},t.send()}catch(e){}})}else t="/img/symbol_sprite.html",o=n.querySelector("body"),(i=new XMLHttpRequest).onload=function(){4==this.readyState&&200==this.status&&o.insertAdjacentHTML("afterbegin",i.responseText)},i.open("GET",t,!0),i.send(null)}(window,document),document.addEventListener("DOMContentLoaded",function(){var e=document.querySelector("body");window.addEventListener("resize",function(){});var t,n,o;t=document.querySelector(".header__burger"),n=document.getElementById("menuModal"),o=function(){t.classList.toggle("active"),n.classList.toggle("block"),n.querySelector("div").classList.toggle("active"),e.classList.toggle("active")},t.onclick=function(){o()},window.addEventListener("click",function(e){e.target!==n&&"A"!==e.target.tagName||o()}),$(".slider").slick({infinite:!1,responsive:[{breakpoint:1024,settings:{slidesToShow:3,infinite:!0}},{breakpoint:600,settings:{slidesToShow:2,dots:!0}},{breakpoint:300,settings:"unslick"}]})});