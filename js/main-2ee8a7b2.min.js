...
"use strict";!function(e,n){var t,o,i;if("localhost"!==location.hostname&&"127.0.0.1"!==location.hostname&&""!==location.host){if(!n.createElementNS||!n.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect)return;var c,s="localStorage"in e&&null!==e.localStorage,l=function(){n.body.insertAdjacentHTML("afterbegin",c)};["/img/symbol_sprite.html","/img/svg/*"].forEach(function(e){console.log(e);try{var t=new XMLHttpRequest;t.open("GET",e,!0),t.onload=function(){200<=t.status&&t.status<400&&(c=t.responseText,n.body?l():n.addEventListener("DOMContentLoaded",l),s&&(localStorage.setItem("inlineSVGdata",c),localStorage.setItem("inlineSVGrev",9)))},t.send()}catch(e){}})}else t="/img/symbol_sprite.html",o=n.querySelector("body"),(i=new XMLHttpRequest).onload=function(){4==this.readyState&&200==this.status&&o.insertAdjacentHTML("afterbegin",i.responseText)},i.open("GET",t,!0),i.send(null)}(window,document),document.addEventListener("DOMContentLoaded",function(){var i=document.querySelector("body");window.addEventListener("resize",function(){});var e,t,n,o;e=document.querySelector(".header__burger"),t=document.querySelector(".canvas"),n=document.getElementById("menuModal"),o=function(){e.classList.toggle("active"),t.classList.toggle("block"),n.classList.toggle("active"),i.classList.toggle("active")},e.onclick=function(){o()},window.addEventListener("click",function(e){e.target!==t&&"A"!==e.target.tagName||o()});var c,s;c=document.querySelectorAll(".callContact"),s=document.getElementById("contactModal"),c.forEach(function(e){e.onclick=function(e){var t,n,o;t=s,n=function(e){e.style.display="none",i.style.overflowY="",i.style.paddingRight="0px"},o=document.documentElement.clientWidth,i.style.overflowY="hidden",i.style.paddingRight=document.documentElement.clientWidth-o+"px",t.style.display="block",t.onclick=function(e){console.log(e.target),e.target.classList.contains("close")&&n(t)},document.addEventListener("keydown",function(e){"Escape"===e.key&&n(t)}),window.addEventListener("click",function(e){})}}),$(".slider").slick({infinite:!1,responsive:[{breakpoint:1024,settings:{slidesToShow:3,infinite:!0}},{breakpoint:600,settings:{slidesToShow:2,dots:!0}},{breakpoint:300,settings:"unslick"}]})});